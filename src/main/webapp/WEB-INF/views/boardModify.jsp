	...
	<div id="page">
				...
				<div class="container">
					<div class="row">
						...
						<div class="col-xs-10 text-right menu-1">
							<ul>
								<!-- li class="active" --><li><a href="index.html">Concert & Busking</a></li>
								...
								<li><a href="cart.html"><!-- <i class="icon-shopping-cart"></i> --> Login</a></li>
							</ul>
						</div>
					</div>
				</div>
		...
		<aside id="colorlib-hero">
			<div class="flexslider">
				...
				<!-- ì´ë¯¸ì§ í¸ì¶ ìë ì  backgrount-size:100%; êµ¬ë¬¸ ì¶ê°  -->
			   	...
			   	<li style="background-image: url(./resources/images/img_bg_2.jpg);background-size:100%;">
			   		<div class="overlay"></div>
			   		<div class="container-fluid">
			   			<div class="row">
				   			<div class="col-md-6 col-md-offset-3 col-md-pull-2 col-sm-12 col-xs-12 slider-text">
			   	...
			   	<li style="background-image: url(./resources/images/img_bg_3.jpg);background-size:100%;">
			   		<div class="overlay"></div>
			   		<div class="container-fluid">
			   			<div class="row">
		...
		<div id="colorlib-featured-product">
			<div align="center"> <!-- class="container" -->
				<div>
					<form action="boardmodify1" name="modify1" method="post" enctype="multipart/form-data">
						...
						<table border=1 style="cellpadding:0;cellspacing:0;border-top:2px solid red;border-bottom:2px solid red;
							...
							<tr style="text-align:center;border-bottom:black;">
								...
								<td style="text-align:left;"><input type="text" name="Board_Title" value="${boardview.board_Title}" style="height:25px;width:600px;"></td>
								<td>${boardview.board_Hit }</td>
								<td>${boardview.board_Date }</td>
							</tr>
						
							<tr style="border-bottom:black;">
								<td colspan="5"><input type="text" name="Board_Content" value="${boardview.board_Content }" style="height:100px;width:900px;"></td>
							</tr>
							
							<tr style="border-bottom:black;">
								<td bgcolor="#d6d6d6">&nbsp;&nbsp;&nbsp;현재 파일</td>
								<td colspan="4"><a href="boardFileDown?board_FileName=${boardview.board_FileName }">&nbsp;&nbsp;&nbsp;${boardview.board_FileName }</a></td>
							</tr>
							
							<tr style="border-bottom:black;">
								<td bgcolor="#d6d6d6">&nbsp;&nbsp;&nbsp;바꿀 파일</td>
								<td colspan="4"><input type="file" name="Board_File"></td> 
							</tr>
							
							<tr>
								<td colspan="5" style="text-align:right;height:30px;">
									<a href="javascript:modify1.submit()">작성하기</a> &nbsp;&nbsp;
