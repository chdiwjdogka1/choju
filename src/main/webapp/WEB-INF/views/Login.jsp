					...
					<div class="row">
						...
						<div class="col-xs-10 text-right menu-1">
							<ul>
								...
								<li><a href="login"><!-- <i class="icon-shopping-cart"></i> --> Login</a></li>
							</ul>
						</div>
					</div>
				</div>
			   			...
			   			<div class="row">
				   			<div class="col-md-6 col-md-offset-3 col-sm-12 col-xs-12 slider-text">
				   				<div class="slider-text-inner text-center">
				   					<h1>Login</h1>
				   					<h2 class="bread"><span><a href="index.html">Home</a></span> <span><a href="Join">Join</a></span></h2>
				   				</div>
				   			</div>
				   		</div>
			   		</div>
...
<!-- 		<aside id="colorlib-hero">
			<div class="flexslider">
				<ul class="slides">
				이미지 호출 안될시  backgrount-size:100%; 구문 추가 
			   	<li style="background-image: url(./resources/images/img_bg_1.jpg);background-size:100%;">
			   		<div class="overlay"></div>
			   		<div class="container-fluid">
			   			<div class="row">
    ...
    <div class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
        <div class="panel panel-success">
            <div class="panel-body" >
                <form action="memberlogin" method="post" id="login">
                    <div style="border:1px solid black">
                        <input type="text" class="form-control" name="id" placeholder="Username" autofocus id="id">
                    </div>
                    <br>
                    <div style="border:1px solid black">
