		...
		<nav class="colorlib-nav" role="navigation">
			<div class="top-menu">
				<div class="container">
					<div class="row">
						<div class="col-xs-2">
							<div id="colorlib-logo"><a href="home">HOME</a></div>
						</div>
							...
							<div class="row">
								<div class="col-md-6 col-md-offset-3 col-sm-12 col-xs-12 slider-text">
									<div class="slider-text-inner text-center">
										<h1>Welcom</h1>
										<h2 class="bread">
											<span><a href="index.html">Home</a></span> <span><a href="join">Join</a></span>
										</h2>
									</div>
								</div>
							</div>
		...
		<article class="container">
			...
			<div class="col-md-6 col-md-offset-3">
				<form action="memberJoin" method="post" name="joinform" id="frm">
					<div class="form-group">
						<label for="InputEmail">ID</label> <input type="email" class="form-control" id="id" placeholder="아이디" oninput="idOverlap" name="id">
						<th><input type="button" onclick="idOverlap()" value="중복확인"></th>
					</div>
					<div class="form-group">
						<label for="InputPassword1">비밀번호</label> <input type="password" class="form-control" id="password" placeholder="비밀번호" oninput="idOverlap" name="password">
					</div>
<!-- 					<div class="form-group">
						<label for="InputPassword2">비밀번호 확인</label> <input type="password" class="form-control" id="InputPassword2" placeholder="비밀번호 확인" oninput="checkId()">
						<p class="help-block">비밀번호 확인을 위해 다시한번 입력 해 주세요</p>
					</div> -->
					<div class="form-group">
						<label for="username">이름</label> <input type="text" class="form-control" id="name" placeholder="이름을 입력해 주세요" name="name">
					</div>
					<div class="form-group">
						<label for="username">성별</label> <input type="text" class="form-control" id="gender" placeholder="성별" name="gender">
					</div>
						<div class="form-group">
						<label for="username">성별</label> <input type="text" class="form-control" id="gender" placeholder="나이" name="age">
					</div>
					<div class="form-group">
						<label for="username">이메일 </label>
						<div class="input-group">
							<input type="tel" class="form-control" id="email" placeholder="@포함" name="email"> <span class="input-group-btn">
				...
				<div class="row">
					<div class="col-md-12 text-center">
						<p>
							...
							<span class="block"> <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --> Copyright &copy;<script>
								document.write(new Date().getFullYear());
							</script> All rights reserved | This template is made with <i class="icon-heart2" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">Colorlib</a> Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0.
							</span> <span class="block">Demo Images: <a href="http://unsplash.co/" target="_blank">Unsplash</a> , <a href="http://pexels.com/" target="_blank">Pexels.com</a></span>
						</p>
					</div>
				</div>
			</div>
